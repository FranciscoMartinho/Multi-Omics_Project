...
saveRDS(xenium.obj_filtered, paste0(file_dir,"xenium.obj_filtered.rds"))
saveRDS(xenium.obj_basis, paste0(file_dir, "xenium.obj_basis.rds"))
saveRDS(xenium.obj_size, paste0(file_dir, "xenium.obj_size.rds"))
saveRDS(xenium.obj_nF, paste0(file_dir, "xenium.obj_nF.rds"))
saveRDS(xenium.obj_nC, paste0(file_dir, "xenium.obj_nC.rds"))
...
xenium.obj_filtered <- readRDS(paste0(file_dir, "xenium.obj_filtered.rds"))
xenium.obj_basis <- readRDS(paste0(file_dir, "xenium.obj_basis.rds"))
xenium.obj_size <- readRDS(paste0(file_dir, "xenium.obj_size.rds"))
xenium.obj_nF <- readRDS(paste0(file_dir, "xenium.obj_nF.rds"))
xenium.obj_nC <- readRDS(paste0(file_dir, "xenium.obj_nC.rds"))
...
file_dir<- "xenium_path"
saveRDS(xenium.obj_size_Counts, paste0(file_dir, "xenium.obj_size_Counts.rds"))
```
...
saveRDS(RCTD, paste0(file_dir,"RCTD.rds"))
...
file_dir <- "example_path"
RCTD<-readRDS(paste0(file_dir, "RCTD.rds"))
...
file_dir<- "example_path"
saveRDS(xenium.obj_size_Counts_cell_types, paste0(file_dir,"xenium.obj_size_Counts_cell_types.rds"))
...
file_dir <- "example_path"
xenium.obj_size_Counts_cell_types<-readRDS(paste0(file_dir,"xenium.obj_size_Counts_cell_types.rds"))
...
file_dir <- "example_path"
png(
  filename = paste0(file_dir, "teste.png"),
...
png( filename = paste0(file_dir, "teste.png"),
...
file_dir <- "example_path"
png( filename = paste0(file_dir, "niche1.plot_3.png"), width = 2000, height = 2000, res = 300 )
print(niche5.plot5)
dev.off()
